...
class AddTopicUseCase(private val topicsRepository: TopicsRepository) {
    suspend fun execute(apiResponseItem: APIResponseItem) = topicsRepository.addTopic(apiResponseItem)
}